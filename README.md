  ...
  [![ORCID](https://img.shields.io/badge/ORCID-0009--0007--0523--6855-a6ce39?logo=orcid&logoColor=white)](https://orcid.org/my-orcid?orcid=0009-0007-0523-6855)
  ...
  *PhD Candidate in Artificial Intelligence | Adaptive Economic Networks*
  ...
  PhD in the National AI Program (Scuola Superiore Sant’Anna & University of Pisa). I build interpretable, data‑grounded models of how economic networks form and evolve when agents adapt, learn, and rewire connections under uncertainty.

  **Core Research**: adaptive cognitive architectures for network formation, multi‑agent reinforcement learning, graph neural networks, statistical validation of ABMs.
  ...
  **Summer Schools & Training**
  ...
  PhD Fellowship (National AI Program) | AI Data Hackathon (2nd) | Alpine Climate Challenge Finalist | Bertelsmann Tech Booster
