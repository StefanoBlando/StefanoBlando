  ...
  **Core Research**: adaptive cognitive architectures for network formation,
  multi‑agent reinforcement learning, graph neural networks, statistical
  validation of ABMs.
  ...
  **PhD Project**: *Learning How to Learn — Adaptive Cognitive Architectures for
  ...
  goal is to move beyond static heuristics toward models that learn *how* to
  learn and *whom* to learn from.

  **Methodological stack**: MARL, GNNs, meta‑learning, statistical model
  checking (MultiVeStA), robust explainability.
  ...
  **Applications**: financial contagion and stability, innovation and knowledge
  ...
  - **MultiVeStA + ABMs**: validation and equilibrium characterization in
  economic models
  - **Topological Stock Prediction**: correlation network topology as
  early‑warning signals
  - **Robust & Functional SDR**: high‑dimensional risk and macro‑financial
  signals
  - **NLP Multi‑Method Validation**: stability of large‑scale text analytics
  across methods
